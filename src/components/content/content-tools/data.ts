export interface IToolsItemType {
  tipTitle: string;
  id: string;
  children: Array<{ title: string; description: string; url: string }>;
}

const IToolsList: Array<IToolsItemType> = [
  {
    tipTitle: "学习路线",
    id: "road",
    children: [
